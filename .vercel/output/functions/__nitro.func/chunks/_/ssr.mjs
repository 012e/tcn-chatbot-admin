...
import { createFileRoute, lazyRouteComponent, createRootRouteWithContext, HeadContent, Scripts, RouterProvider, Link, createRouter as createRouter$1 } from '@tanstack/react-router';
...
async function loadVirtualModule(id) {
  switch (id) {
    ...
    case VIRTUAL_MODULES.startManifest:
      return await import('./_tanstack-start-manifest_v-DrjNxuYQ.mjs');
...
function Header() {
  return /* @__PURE__ */ jsxs("header", { className: "flex sticky top-0 z-50 justify-between items-center px-4 w-full h-16 border-b md:px-6 shrink-0 bg-background", children: [
    /* @__PURE__ */ jsx(NavigationMenu, { children: /* @__PURE__ */ jsxs(NavigationMenuList, { children: [
      /* @__PURE__ */ jsx(NavigationMenuItem, { children: /* @__PURE__ */ jsx(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/chat", className: navigationMenuTriggerStyle(), children: "Chat" }) }) }),
      /* @__PURE__ */ jsx(NavigationMenuItem, { children: /* @__PURE__ */ jsx(NavigationMenuLink, { asChild: true, children: /* @__PURE__ */ jsx(Link, { to: "/document", className: navigationMenuTriggerStyle(), children: "Tài liệu" }) }) })
    ] }) }),
    /* @__PURE__ */ jsx("div", { className: "flex gap-2 items-center" })
  ] });
}
function LayoutAddition() {
  return /* @__PURE__ */ jsx(ReactQueryDevtools, { buttonPosition: "bottom-right" });
}
const appCss = "/assets/styles-CNC-GZKO.css";
...
function RootDocument({ children }) {
  return /* @__PURE__ */ jsxs("html", { lang: "en", suppressHydrationWarning: true, children: [
    ...
    /* @__PURE__ */ jsxs("body", { className: "w-screen h-screen", children: [
      /* @__PURE__ */ jsx(Header, {}),
      children,
      /* @__PURE__ */ jsx(TanStackRouterDevtools, {}),
      /* @__PURE__ */ jsx(LayoutAddition, {}),
      /* @__PURE__ */ jsx(Toaster, { expand: true }),
      /* @__PURE__ */ jsx(Scripts, {})
    ] })
  ] });
}
const $$splitComponentImporter$6 = () => import('./login-B0RbzR9A.mjs');
const Route$6 = createFileRoute("/login")({
  component: lazyRouteComponent($$splitComponentImporter$6, "component")
});
const $$splitComponentImporter$5 = () => import('./document-E442pt-O.mjs');
const Route$5 = createFileRoute("/document")({
  component: lazyRouteComponent($$splitComponentImporter$5, "component")
});
const $$splitComponentImporter$4 = () => import('./chat-C9Cc0v5l.mjs');
const Route$4 = createFileRoute("/chat")({
  component: lazyRouteComponent($$splitComponentImporter$4, "component")
});
const $$splitComponentImporter$3 = () => import('./index-CLk0BWgC.mjs');
const Route$3 = createFileRoute("/")({
  component: lazyRouteComponent($$splitComponentImporter$3, "component")
});
const $$splitComponentImporter$2 = () => import('./index-4YvGhlhz.mjs');
const Route$2 = createFileRoute("/document/")({
  validateSearch: z$1.object({
    page: z$1.coerce.number().int().min(1).catch(1),
    pageSize: z$1.coerce.number().int().min(1).max(100).catch(20),
    id: z$1.coerce.number().int().optional().catch(void 0)
  }),
  component: lazyRouteComponent($$splitComponentImporter$2, "component")
});
const $$splitComponentImporter$1 = () => import('./new-Ci0LEVUx.mjs');
const Route$1 = createFileRoute("/document/new")({
  component: lazyRouteComponent($$splitComponentImporter$1, "component")
});
const loginCredentialAtom = atomWithStorage("credential", void 0);
const API_BASE = "https://012e-tcn-chatbot.deno.dev/api";
...
const $$splitComponentImporter = () => import('./_documentId.edit-BOsZ81gp.mjs');
const Route = createFileRoute("/document/$documentId/edit")({
  loader: async ({
    params
  }) => {
    const {
    ...
    const document2 = await getDocumentById(documentId);
    if (!document2) {
      throw new Error(`Document with ID ${documentId} not found`);
    }
    return document2;
  },
  pendingComponent: () => /* @__PURE__ */ jsx("div", { className: "w-full h-full", children: /* @__PURE__ */ jsx("div", { className: "flex justify-center items-center h-full", children: /* @__PURE__ */ jsx(Loader2, { className: "animate-spin size-10" }) }) }),
...
const DocumentRoute = Route$5.update({
  id: "/document",
  path: "/document",
  getParentRoute: () => Route$7
});
...
const DocumentIndexRoute = Route$2.update({
  id: "/",
  path: "/",
  getParentRoute: () => DocumentRoute
});
const DocumentNewRoute = Route$1.update({
  id: "/new",
  path: "/new",
  getParentRoute: () => DocumentRoute
});
const DocumentDocumentIdEditRoute = Route.update({
  id: "/$documentId/edit",
  path: "/$documentId/edit",
  getParentRoute: () => DocumentRoute
});
const DocumentRouteChildren = {
  DocumentNewRoute,
  DocumentIndexRoute,
  DocumentDocumentIdEditRoute
};
...
export { Route$6 as R, Route$2 as a, listDocuments as b, cn as c, deleteDocument as d, serverEntry as default, createDocument as e, Route as f, loginCredentialAtom as l, updateDocument as u };
